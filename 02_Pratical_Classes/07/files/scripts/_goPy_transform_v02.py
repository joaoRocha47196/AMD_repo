...
def generateDataFile_basket( basket, fileNameOUT ):
    with open ( fileNameOUT, mode='wt', encoding='utf-8' ) as f:
        ...
        for transactionID in basket:
            ...
            line = ", ".join(items.keys())  # Join item IDs with comma
            f.write( line + '\n' )
    ...
    with open ( fileNameOUT, mode='wt', encoding='utf-8' ) as f:
        ...
        for transactionID in all_transactionID_list:
            ...
            for itemID, count in basket[transactionID].items():
                ...
                line_list[itemID_index] = count  # Set item count
...
if __name__=="__main__":
    ...
    fIN  = "z_dataset_sample_OUT_result.txt" #"z_abstract_test.txt" #"z_dataset_sample_OUT.txt"
