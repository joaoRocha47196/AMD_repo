...
class ModelNaiveBayes:
    ...
    def fit(self):
        ...
        for (train_index, test_index) in StratifiedShuffleSplit(n_splits=5, test_size=0.3, random_state=None).split(self.X, self.y):
...
def main():
    filenameLenses = 'd01_lenses.tab'
    naive_bayes_model = ModelNaiveBayes(filenameLenses)
